...
is removed from the app. [See examples here.](InteractiveComplexHeatmap.html#only-respond-to-one-event)
...
`htShinyExample(9.1)` demonstrates output floating under `"hover"`, `"click"`
and `"dblclick"`. `htShinyExample(9.2)` demonstrates a slightly complex
exmaple where the output for clicking and hovering are all self-defined. Demons are as follows:

<blockquote class="twitter-tweet"><p lang="en" dir="ltr">The second figure shows a self-defined output. The heatmap visualizes GO similarities. <a href="https://t.co/MmKG035BDE">pic.twitter.com/MmKG035BDE</a></p>&mdash; Zuguang Gu (@jokergoo_gu) <a href="https://twitter.com/jokergoo_gu/status/1365399153845678084?ref_src=twsrc%5Etfw">February 26, 2021</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
