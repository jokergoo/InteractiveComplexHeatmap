...
the initial sizes of the two boxes. You can check `ht_shiny_example(16)` where the size of the heatmap box is
...
single cell appears and fastly disappears. Currently I don't have a solution to
get rid of that.
...
One last example is `ht_shiny_example(23)` where the heatmap visualizes
correlations of a list of Gene Ontology terms. In this example, the click
and brush actions are self-defined so that the selected GO ids as well as
their detailed descriptions are printed.
