...
example, the matrix is reordered by a selected column:
...
A similar but slightly complex example is as follows. It can be run by `htShinyExample(6.8)`.
...
The second scenario is the interactive heatmap widget is dynamically generated and inserted.
