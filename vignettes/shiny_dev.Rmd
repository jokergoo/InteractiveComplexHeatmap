...
<img src="https://jokergoo.github.io/images/app_demo1.png" width="100%" />
...
<img src="https://jokergoo.github.io/images/app_demo2.png" width=100% />
...
A brush on heatmap triggers two responses, one in the sub-heatmap and one in the output. If `"brush-output"`
is included in `response`, you can still brush on the heatmap, but there is only response in the output.

`InteractiveComplexHeatmapOutput()` manages the three components. The three components can also be
separated into `mainHeatmapOutput()`, `subHeatmapOutput()` and `HeatmapInfoOutput()`. Then, it is possible
to integrate with other packages such as **shinydashboard**.
...
<img src="https://jokergoo.github.io/images/shinydashboard.png" width="100%" />

Please note, since now the three components are generated independently, to correctly connect the three components
as well as the server side, the heatmap ID must be explicitely specified in all the functions.
More examples on integrating with **shinydashboard** can be found with `htShinyExample(10.1)` and `htShinyExample(10.2)`.
...
<img src="https://jokergoo.github.io/images/rmarkdown.png" width="100%" />
...
If users want to use the values in `input` or `session`, `click_action` and `brush_action` can also
...
<img src="https://jokergoo.github.io/images/customize_output.png" width="100%" />
...
<img src="https://jokergoo.github.io/images/customize_output2.png" width="100%" />
...
<img src="https://jokergoo.github.io/images/customize_output3.png" width="100%" />
...
<img src="https://jokergoo.github.io/images/deseq2.gif" width="100%" />
...
<img src="https://jokergoo.github.io/images/corrheatmap.gif" width="100%" />
...
<img src="https://jokergoo.github.io/images/float1.gif" width="100%" />
...
<img src="https://jokergoo.github.io/images/float2.gif" width="100%" />

## Compact mode

In `InteractiveComplexHeatmapOutput()`, argument `compact` can be set to `TRUE`, so there is only the main heatmap
...
```{r, eval = FALSE}
new_output_ui = ...
InteractiveComplexHeatmap(..., response = c(action, "brush-output"), 
    output_ui = new_output_ui, output_ui_float = TRUE)
```
...
<img src="https://jokergoo.github.io/images/dynamic_widget4.gif" width="100%" />
...
<img src="https://jokergoo.github.io/images/dynamic_widget.gif" width="100%" />
...
<img src="https://jokergoo.github.io/images/dynamic_widget_radio_selection.gif" width="100%" />
...
<img src="https://jokergoo.github.io/images/dynamic_widget2.gif" width="100%" />
...
<img src="https://jokergoo.github.io/images/dynamic_widget3.gif" width="100%" />
