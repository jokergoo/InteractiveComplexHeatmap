...
1. [How to visualize heatmaps interactively](https://bioconductor.org/packages/release/bioc/vignettes/InteractiveComplexHeatmap/inst/doc/InteractiveComplexHeatmap.html)
2. [How interactive complex heatmap is implemented](https://bioconductor.org/packages/release/bioc/vignettes/InteractiveComplexHeatmap/inst/doc/implementation.html)
3. [Functions for Shiny app development](https://bioconductor.org/packages/release/bioc/vignettes/InteractiveComplexHeatmap/inst/doc/shiny_dev.html)
4. [Decorations on heatmaps](https://bioconductor.org/packages/release/bioc/vignettes/InteractiveComplexHeatmap/inst/doc/decoration.html)
5. [Interactivate heatmaps indirectly generated by pheatmap(), heatmap.2() and heatmap()](https://bioconductor.org/packages/release/bioc/vignettes/InteractiveComplexHeatmap/inst/doc/interactivate_indirect.html)
6. [A Shiny app for visualizing DESeq2 results](https://bioconductor.org/packages/release/bioc/vignettes/InteractiveComplexHeatmap/inst/doc/deseq2_app.html)
7. [Implement interactive heatmap from scratch](https://bioconductor.org/packages/release/bioc/vignettes/InteractiveComplexHeatmap/inst/doc/from_scratch.html)
